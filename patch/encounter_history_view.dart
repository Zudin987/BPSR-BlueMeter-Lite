...
import '../core/data/lite_scene_catalog.dart';
...
String? _historySceneName(LiteEncounterHistory encounter) {
  ...
  return LiteSceneCatalog.nameFor(encounter.mapId);
}
...
String _historyTitle(LiteEncounterHistory encounter) {
  ...
  // Do not display an unverified numeric ID. Earlier manual Social-packet
  // decoding could mistake the player's UID for a map ID.
